...
namespace BookKart.DataAccess.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        public DbSet<CompanyDALModel> Companies { get; set; }
        public DbSet<ApplicationUser> ApplicationUsers { get; set; }
        public DbSet<ShoppingCartDALModel> ShoppingCarts { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CompanyDALModel>().HasData(
                new CompanyDALModel
                {
                    Id = 1,
                    Name = "Tech Solution",
            ...
            modelBuilder.Entity<ProductDALModel>().HasData(
                new ProductDALModel
                {
                    Id = 1,
