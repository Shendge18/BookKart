...
namespace BookKartWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0)
            {
                string dummyPaymentId = Guid.NewGuid().ToString();
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            if (orderHeader.PaymentStatus != SD.PaymentStatusDelayedPayment)
            {
                ...
                {
                    _unitOfWork.OrderHeader.UpdateStripePaymentID(id, dummySessionId, dummyPaymentIntentId);
        ...
        private double GetPriceBasedOnQuantity(ShoppingCartDALModel shoppingCart)
        {
